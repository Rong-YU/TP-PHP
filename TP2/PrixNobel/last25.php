...
require "begin.html";
echo "<table>";
echo '<tr><th>Name</th><th>Category</th><th>Year</th><th class="sansBordure"></th><th class="sansBordure"></th></tr>';
foreach ($tab as $personne) {
  ...
  echo '<td class="sansBordure"><a href="form_update.php?id='.$personne["id"].'"><img src="Content/img/edit-icon.png"></a></td>';
  echo "</tr>";
}
echo "</table>";
